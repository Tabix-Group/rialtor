...
const DOCUSMART_FIELDS = {
  ...
  bloque_d_20: { block: 'D', blockName: 'Dominio y cargas', label: 'Tipo de dominio',                                prompt: 'Dominio: Pleno, Condominio (indicar partes indivisas), Usufructo, Nuda propiedad, u otro' },
  bloque_d_21: { block: 'D', blockName: 'Dominio y cargas', label: 'Usufructo (sí/no + titulares)',                  prompt: '¿Existe usufructo? Sí o No. Si sí, indicar los titulares del usufructo.' },
  bloque_d_22: { block: 'D', blockName: 'Dominio y cargas', label: 'Hipoteca (sí/no + estado)',                      prompt: '¿Existe hipoteca? Sí o No. Si sí: estado (vigente, cancelable en el acto, cancelada)' },
  bloque_d_23: { block: 'D', blockName: 'Dominio y cargas', label: 'Embargo (sí/no)',                                prompt: '¿Existe embargo sobre el inmueble o las partes? Sí o No' },
  bloque_d_24: { block: 'D', blockName: 'Dominio y cargas', label: 'Inhibición (sí/no)',                             prompt: '¿Existe inhibición general de bienes? Sí o No' },
  bloque_d_25: { block: 'D', blockName: 'Dominio y cargas', label: 'Protección de vivienda / bien de familia',       prompt: '¿El inmueble tiene afectación a protección de vivienda (ex bien de familia)? Sí o No' },
  bloque_d_26: { block: 'D', blockName: 'Dominio y cargas', label: 'Servidumbres / restricciones',                   prompt: '¿Existen servidumbres, restricciones al dominio u otras afectaciones? Sí o No. Si sí, describir brevemente.' },

  bloque_e_27: { block: 'E', blockName: 'Económico', label: 'Precio total',                                          prompt: 'Precio total de la operación (en números y en letras si consta)' },
  bloque_e_28: { block: 'E', blockName: 'Económico', label: 'Moneda',                                                prompt: 'Moneda: Pesos argentinos (ARS), Dólares (USD), u otra' },
  bloque_e_29: { block: 'E', blockName: 'Económico', label: 'Forma de pago',                                         prompt: 'Forma de pago: Transferencia, Efectivo, Crédito hipotecario, Mixto. Describir.' },
  bloque_e_30: { block: 'E', blockName: 'Económico', label: 'Anticipo / seña / reserva',                             prompt: 'Monto del anticipo, seña o reserva entregado o pactado' },
  bloque_e_31: { block: 'E', blockName: 'Económico', label: 'Saldo',                                                 prompt: 'Monto del saldo a pagar y oportunidad (escritura, posesión, etc.)' },
  bloque_e_32: { block: 'E', blockName: 'Económico', label: 'Condición crédito hipotecario',                         prompt: '¿La operación está sujeta a crédito hipotecario? Sí o No. Si sí, banco interviniente.' },
  bloque_e_33: { block: 'E', blockName: 'Económico', label: 'Origen de fondos declarado',                            prompt: '¿Se declara el origen lícito de los fondos (art. 303 CCCN o UIAF)? Sí o No' },

  bloque_f_34: { block: 'F', blockName: 'Plazos y entrega', label: 'Fecha máxima de escrituración',                  prompt: 'Fecha límite para la escrituración (en boleto de compraventa)' },
  bloque_f_35: { block: 'F', blockName: 'Plazos y entrega', label: 'Modalidad de posesión',                          prompt: 'Posesión: Inmediata a la firma, Diferida (indicar fecha/condición), u Ocupada' },
  bloque_f_36: { block: 'F', blockName: 'Plazos y entrega', label: 'Fecha de entrega de posesión',                   prompt: 'Fecha o plazo para la entrega de la posesión del inmueble' },
  bloque_f_37: { block: 'F', blockName: 'Plazos y entrega', label: 'Llaves: cuándo y contra qué',                    prompt: 'Condición de entrega de llaves: cuándo y contra qué evento o pago' },

  bloque_g_38: { block: 'G', blockName: 'Cláusulas de conflicto', label: 'Penalidad incumplimiento comprador',       prompt: 'Consecuencia/penalidad si el comprador incumple (pérdida de seña, multas, etc.)' },
  bloque_g_39: { block: 'G', blockName: 'Cláusulas de conflicto', label: 'Penalidad incumplimiento vendedor',        prompt: 'Consecuencia/penalidad si el vendedor incumple (devolución doble de seña, multas, etc.)' },
  bloque_g_40: { block: 'G', blockName: 'Cláusulas de conflicto', label: 'Distribución de gastos',                   prompt: 'Quién paga cada gasto: escribanía, sellos, impuesto de transferencia, ITI, plusvalía, etc.' },
  bloque_g_41: { block: 'G', blockName: 'Cláusulas de conflicto', label: 'Comisión inmobiliaria',                    prompt: 'Porcentaje de comisión, quién la paga (comprador, vendedor, ambos) y cuándo' },
  bloque_g_42: { block: 'G', blockName: 'Cláusulas de conflicto', label: 'Condiciones suspensivas/resolutorias',     prompt: 'Condiciones suspensivas o resolutorias: texto de la cláusula y tipo' },
};
