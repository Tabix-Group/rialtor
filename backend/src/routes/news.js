...
router.get('/sources', authenticateToken, authorizeRoles('ADMIN'), getRSSSourcesList);
router.post('/sync', authenticateToken, authorizeRoles('ADMIN'), syncRSSFeed);
router.post('/sync/:source', authenticateToken, authorizeRoles('ADMIN'), syncSpecificSource);
