            ...
            {numericTransactionPrice > 0 ? (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                  ...
                  <div id="writing-calculation-results" className="space-y-6 bg-white p-4 rounded-xl">
                        ...
                        {calculations.realEstateFee > 0 && (
                            <div className="flex justify-between items-center px-4 py-3">
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">{(activeTab === 'comprador' || activeTab === 'primera') ? '4,00%' : '3,00%'} + IVA</div>
                                </div>
