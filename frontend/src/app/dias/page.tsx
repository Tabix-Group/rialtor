                        ...
                        {mode === 'between-dates' && result && (
                            <div className="space-y-6">
                                <div className="bg-white rounded-xl shadow-lg p-6">
                                    ...
                                    <div id="days-calculation-results" className="space-y-6 bg-white p-4 rounded-xl">
                                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                                            ...
                                            <div className="text-sm text-gray-600 text-center bg-gray-50 rounded p-2 mt-4">
                        ...
                        {mode === 'due-date' && dueDateResult && (
                            <div className="space-y-6">
                                <div className="bg-white rounded-xl shadow-lg p-6">
                                    ...
                                    <div id="due-date-calculation-results" className="space-y-6 bg-white p-4 rounded-xl">
                                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
