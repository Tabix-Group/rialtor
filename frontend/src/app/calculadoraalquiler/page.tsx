...
const RATE_OPTIONS = [
  ...
  { value: 'is', label: 'IS - Índice Salarial' },
  { value: 'ipim', label: 'IPIM - Índice de Precios Internos al por Mayor' },
  { value: 'casa_propia', label: 'Casa Propia - Coeficiente Casa Propia' },
  { value: 'cac', label: 'CAC - Cámara Argentina de la Construcción' },
...
export default function CalculadoraAlquilerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authenticatedFetch('/api/calculator/rent', {
        method: 'POST',
        headers: {
        ...
        <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="flex-1 w-full">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-4 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-semibold text-white">Calculadora Alquileres</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-3 sm:mb-4 tracking-tight">
              Proyección de <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent">Aumentos</span>
            </h1>

            <p className="text-base sm:text-lg lg:text-xl text-slate-300 mb-6 sm:mb-8 max-w-2xl leading-relaxed">
              Calculá las proyecciones de aumentos de alquiler basados en índices económicos oficiales de Argentina.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
                >
          ...
          <div className="lg:col-span-2">
            {result ? (
              <div className="space-y-6">
                ...
                <div id="rent-calculation-results" className="space-y-6 bg-white p-4 rounded-xl">
                  {/* Resumen */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <p className="text-sm text-gray-600">Índice de ajuste</p>
                      <p className="text-2xl font-bold text-blue-600">
                        {RATE_OPTIONS.find(r => r.value === result.inputs.rate)?.label.split(' - ')[0] || result.inputs.rate.toUpperCase()}
                      </p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700">
                          Los cálculos se basan en índices económicos oficiales. Los valores marcados como "estimados" son proyecciones que pueden variar según la evolución real de los índices.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div className="space-y-4">
                      {result.projections
                        ...
                        .slice(0, 3) // Mostrar solo los primeros 3 con detalles
              ...
              <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-600 mb-4">Calculadora de Alquileres</h3>
                <p className="text-gray-500 text-lg max-w-md mx-auto">
                  Completa los parámetros a la izquierda para obtener una proyección detallada de los aumentos de alquiler basados en índices económicos.
                </p>
              </div>
            )}
          </div>
