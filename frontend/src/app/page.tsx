    ...
    <div className="min-h-screen bg-[#000410] flex flex-col">
      ...
      <section className="w-full" style={{ backgroundColor: '#010413' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center" style={{ paddingTop: '3vw', paddingBottom: '3vw' }}>
          <img src="/images/logo9.jpeg" alt="Logo RE/MAX" className="w-[28rem] h-[28rem] md:w-[38rem] md:h-[38rem] object-contain" style={{ background: 'none', borderRadius: 0, boxShadow: 'none', padding: 0, margin: 0 }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
            ...
            <div className="md:col-span-1 flex flex-col items-start mb-8 md:mb-0">
              <div className="flex items-center space-x-3 mb-4">
                <img src="/images/logo9.jpeg" alt="Logo Rialtor" className="w-20 h-20 object-contain m-0 p-0" style={{ background: 'none', borderRadius: 0, boxShadow: 'none', padding: 0, marginTop: 0, marginBottom: 0 }} />
